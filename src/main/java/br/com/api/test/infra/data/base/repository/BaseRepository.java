package br.com.api.test.infra.data.base.repository;
...
public abstract class BaseRepository<
    ...
    implements IBaseRepository<TEntity, TIdentity> {
  ...
  public BaseRepository(EntityManager em, Class<TEntity> persistedClass) {
